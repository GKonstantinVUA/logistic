...
export let gotoBlock = (targetBlock, noHeader = false, speed = 500, offsetTop = 0, timeOut = 600) => {
	const targetBlockElement = document.querySelector(targetBlock);

	// Закриваємо меню, якщо воно відкрите
	document.documentElement.classList.contains("menu-open") ? menuClose() : null;
	// timeOut ставимо на випадок коли до картинок не додані атрибути width та height чи сторінка довго завантажуєтсья
	setTimeout(() => {
